...
import { Chip, FormLabel, Grid, Typography } from "@material-ui/core";
import {
  History,
  Timelapse,
  Category,
...
export const PriorityList: FC<{ store: Store<AppState> }> = ({
  store,
  ...props
}) => {
    ...
    <MovableList
      ...
      renderList={({ children, props }) => (
        <>
          ...
          <Typography variant="body2">(drag to prioritise)</Typography>
