...
export const ALL_ENTRIES: Immutable<Entry[]> = [
  /** EMPLOYMENT */
  {
    ...
    intro: "Full Stack Devops serving Billing user journeys.",
    body: "Migrating, maintaining and shipping a full-stack Typescript billing experience with Vite+Vue3 frontend and OpenApi backend. Deployed through CircleCI. Instrumented with Amplitude, Sentry. Pairing to deliver third-line support for an extended team of developers.",
  },
  {
    org: "BBC",
  ...
  /** SOCIETY */
  {
    ...
    intro:
      "Creator of and contributor to multiple open source repositories in support of Typescript, Micropython, Arduino. ",
    body: "Feature requests, bug reports and patches to multiple public projects. Top 0.5% Stackoverflow contributor. Mars 2020 Helicopter and Arctic Code Vault Contributor",
  },
  {
